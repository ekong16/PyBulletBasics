...
ACTIONS_NAME = "multi_trial_strategy_actions.npy"
MSE_NAME = "multi_trial_strategy_mse.npy"


def save_trial_mp4(
    full_video_buffer, actions, mse_log, trial_idx, folder="eval_replays"
):
